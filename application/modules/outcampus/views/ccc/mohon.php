		...
		<div class="card-body">
			<div class="mb-4 row align-items-center">
				<label for="exampleInputText5"
					class="form-label fw-semibold col-sm-3 col-form-label text-end">Name</label>
				<div class="col-sm-9">
					NOORHAZREEN BINTI AMRI
				</div>
			</div>
			<div class="mb-4 row align-items-center">
				<label for="exampleInputText5" class="form-label fw-semibold col-sm-3 col-form-label text-end">No
					Matrik</label>
				<div class="col-sm-9">
					S62000
				</div>
			...
			<div class="mb-4 row align-items-center">
				<label for="exampleInputText5"
					class="form-label fw-semibold col-sm-3 col-form-label text-end">Penyelia</label>
				<div class="col-sm-9">
			...
			<div class="mb-4 row align-items-center">
				<label for="exampleInputText5"
					class="form-label fw-semibold col-sm-3 col-form-label text-end">Mula</label>
				<div class="col-sm-9">
			...
			<div class="mb-4 row align-items-center">
				<label for="exampleInputText5"
					class="form-label fw-semibold col-sm-3 col-form-label text-end">Hingga</label>
				<div class="col-sm-9">
					<input type="text" class="form-control" id="exampleInputText6" placeholder="dd/mm/yyyy">
				</div>
			</div>
			...
			<div class="mb-4 row align-items-center">
				<label for="startDate" class="form-label fw-semibold col-sm-3 col-form-label text-end">Jenis
					Pengangkutan</label>
				<div class="col-sm-9">
					<div class="input-group">
			...
			<div class="mb-4 row align-items-center">
				<label for="startDate" class="form-label fw-semibold col-sm-3 col-form-label text-end">Alasan Sekiranya
					Menggunakan Kenderaan Sendiri</label>
				<div class="col-sm-9">
					<div class="input-group">
						<textarea type="text" class="form-control" id="exampleInputText6" placeholder="Alasan"
							rows"4"> </textarea>
					</div>
				</div>
			</div>
