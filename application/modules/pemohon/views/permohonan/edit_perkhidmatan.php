...
?>
<form action="<?php echo module_url('permohonan/kemaskini_perkhidmatan') ?>" method="post"
                        ...
                        <div class="card <?= $background ?>">
                            <div class="card-body p-2 d-flex align-items-center gap-3 border border-rounded">
                                ...
                                <?php if ($list->T03_NAMA_PERKHIDMATAN == 'Pengacara Majlis') { ?>
                                    <div class="flex-shrink-0 ms-5 me-5">
                                        <input class="form-check-input secondary border" type="checkbox" <?= $checked ?>
                                            id="pengacaraCheckbox" name="perkhidmatan[]" <?php foreach ($data as $row) {
                                ...
                                <?php } else if ($list->T03_NAMA_PERKHIDMATAN == 'Reka Bentuk Grafik') { ?>
                                        ...
                                        <div class="flex-shrink-0 ms-5 me-5">
                                            <input class="form-check-input secondary" type="checkbox" <?= $checked ?>
                                                ...
                                                data-bs-target="#modalRekaBentukGrafik" name="perkhidmatan[]" <?php foreach ($data as $row) {
                                                    if ($row->T03_ID == $list->T03_ID) {
                                                        echo "checked disabled";
                                                    }
                                                } ?>
                                ...
                                <?php } else if ($list->T03_NAMA_PERKHIDMATAN == 'Montaj') { ?>
                                            ...
                                            <!-- MODAL UNTUK MONTAJ -->
                                            <div class="modal fade" id="modalMontaj" tabindex="-1" aria-labelledby="modalMontajLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input class="form-control" type="file" id="reka_bentuk_grafik_file" name="reka_bentuk_grafik_file">
                </div>
            </div>
            <div class="modal-footer">
...
<!-- MODAL UNTUK MONTAJ -->
<div class="modal fade" id="modalMontaj" tabindex="-1" aria-labelledby="modalMontajLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalMontajLabel">Montaj</h5>
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="montaj_file" class="form-label">Sila masukkan idea rekaan papan cerita
                    </label>
                    <input class="form-control" type="file" id="montaj_file" name="montaj_file">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
