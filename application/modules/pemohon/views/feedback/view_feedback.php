...
<div class="card shadow-lg p-4 mb-4 bg-white rounded">
    ...
    <div class="card-body">
        ...
        <!-- <div class="card p-3 mb-3">
            <p class="fw-bold">Maklum balas:</p>
            <p><?= isset($feedback->T06_FEEDBACK) ? ($feedback->T06_FEEDBACK instanceof OCILob ? $feedback->T06_FEEDBACK->load() : $feedback->T06_FEEDBACK) : 'Tiada maklum balas.' ?>
            </p>
        </div> -->
        ...
        <!-- <div class="card p-3 mb-3">
            <p class="fw-bold">Cadangan penambahbaikan:</p>
            <p><?= isset($feedback->T06_PENAMBAHBAIKAN) ? ($feedback->T06_PENAMBAHBAIKAN instanceof OCILob ? $feedback->T06_PENAMBAHBAIKAN->load() : $feedback->T06_PENAMBAHBAIKAN) : 'Tiada cadangan.' ?>
            </p>
        </div> -->
        <!-- <div class="mb-3">
        ...
        <div class="text-center">
            <a href="https://docs.google.com/forms/d/e/1FAIpQLScNecJgWhUB4jHrI8bAUqvoLk42H0lwnltR2j1KpC8ZAlwmeQ/viewform"
                class="btn btn-primary" target="_blank">Borang Maklum Balas</a>
        </div>

        <div id="button-done" style="display: none;">
            <button type="button" class="btn btn-primary mt-3"
                onclick="window.location.href='<?= module_url('permohonan/view_program') ?>'">Selesai</button>
