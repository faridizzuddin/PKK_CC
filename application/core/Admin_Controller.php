...
class Admin_Controller extends Base_Controller
{
    ...
    {
        //$_SESSION["icno"] = "820519115343"; //BUKA UNTUK LOAD PAGE TANPA LOGIN SESSION LOCALHOST
        ...
        if (!isset($_SESSION["icno"])) {
            ...
            redirect($link);
            //http://localhost/myprojek/pemohon/permohonan/login
        }
